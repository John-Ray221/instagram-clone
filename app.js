               ...
               querySnapshot.forEach((doc) => {
                   ...
                   <div class="header">
                     <div class="profile-area">
                       ...
                       <span class="profile-name">${doc.data().displayName}</span>
                     </div>
                     <div class="options">
                       <div
                   ...
                   <div class="footer">
                     ...
                     <span class="likes"
                       >Likes ${doc.data().likes}</span>
                     <span class="caption">
                       <span class="caption-username"><b>${doc.data().displayName}</b></span>
